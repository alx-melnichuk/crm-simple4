...
import { ClientDto } from '../lm-client/_interfaces/client-dto.interface';
import { API_CLIENT, QP_CLIENT_IDS } from '../lm-client/_services/client-api.service';
...
export class MockClientInterceptor implements HttpInterceptor {
  ...
  public intercept(request: HttpRequest<unknown>, next: HttpHandler): Observable<HttpEvent<unknown>> {
    ...
    switch (request.method) {
      case 'GET':
        const ids1Text = request.params.get(QP_CLIENT_IDS);
